...
public class CustomItemProperty {
    ...
    public static final int FirearmType = 144;
    public static final int Firepower = 145;
    public static final int FirearmRange = 146;
    public static final int FirearmReloadSpeed = 147;
    public static final int FirearmAmmoType = 149;
    public static final int FirearmMagazineCapacity = 151;
    public static final int FirearmRateOfFire = 152;
